        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Skill Section Information</h4>
                        ...
                        <table id="example3" class="display " style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('/public/skillimage/'. $item->image) }}" alt="" style="width: 40px" height="40px">
                                    </td>
                                    <td>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                      Slill Section Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <form class="form-valide" action="{{ route('store_skillsection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body py-2 px-4">
                        <div class="row">
                             <div class="col-md-6">
                               <div class="row">
                                    <label class="col-md-5 col-form-label">Technology name:
                                        <span class="text-danger">*</span>
                                   </label>
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Technology name" required name="tech" class="form-control">
                                   </div>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="row" id="viewImage" >
                                    <label class="col-md-5 col-form-label">tech-image</label>
                                    <div class="col-md-7">
       ...
       <div class="modal fade bd-example-edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                     Skill Update page Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
              <form class="form-valide" action="{{ route('update_skillsection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body py-2 px-4">
                        ...
                        <div class="row">
                             <div class="col-md-6">
                               <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Technology name" id="tecedit" name="tech" class="form-control">
                                   </div>
                                </div>
                            </div>
                             <div class="col-md-6">
                        ...
                        <div class="row">
                             <div class="col-md-6">
                               <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Technology name" id="tecview" readonly name="tech" class="form-control">
                                   </div>
                                </div>
                            </div>
...
<script>
    $(document).on('click','#editData',function(){
        ...
        success: function (response) {
            ...
            $('#tecedit').val(response.techname);
            var imageUrl = response.image;
            var fullImageUrl = "{{ asset('public/skillimage') }}/" + imageUrl;
