        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Service Section Information</h4>
                        ...
                        <table id="example3" class="display " style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('/public/serviceimage/'. $item->image) }}" alt="" style="width: 40px" height="40px">
                                    </td>
                                    <td>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-valide" action="{{ route('store_servicesection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                   ...
                                   <div class="col-md-7">
                                       <textarea name="des" id="" rows="3" cols="3" class="form-control"></textarea>
                                   </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row" id="viewImage" >
                                    <label class="col-md-5 col-form-label">Service-image</label>
                                    <div class="col-md-7">
       ...
       <div class="modal fade bd-example-edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                     Service Update page Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
              <form class="form-valide" action="{{ route('update_servicesection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body py-2 px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                   ...
                                   <div class="col-md-7">
                                       <textarea name="des" id="desedit" rows="3" cols="3" class="form-control"></textarea>
                                   </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                   ...
                                   <div class="col-md-7">
                                       <textarea name="des" id="desview" readonly rows="3" cols="3" class="form-control"></textarea>
                                   </div>
                                </div>
                            </div>
...
<script>
    $(document).on('click','#editData',function(){
        ...
        success: function (response) {
            ...
            var fullImageUrl = "{{ asset('public/serviceimage') }}/" + imageUrl;
