        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">testimonium Section Information</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display " style="min-width: 845px">
                            ...
                            <tbody>
                                @foreach ($Testimonium as $item )
                                <tr>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->address }}</td>

                                    <td>
                                      <img src="{{ asset('/public/testimoniumimage/'. $item->image) }}" alt="" style="width: 40px" height="40px">
                                    </td>
                                    <td>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                      Testimonium Section Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <form class="form-valide" action="{{ route('store_testimoniumsection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Title" required name="address" class="form-control">
                                   </div>
                                </div>
                            </div>
                        </div>
                         <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-5 col-form-label">Description:
                                        <span class="text-danger">*</span>
                                   </label>
                                   <div class="col-md-7">
                                        <textarea name="des" id="" cols=10" rows="3" class="form-control"></textarea>
                                   </div>
                                </div>
                            </div>
                             <div class="col-md-6">
       ...
       <div class="modal fade bd-example-edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                      Testimonium Update page Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
            <form class="form-valide" action="{{ route('update_testimoniumsection') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body py-2 px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Title" id="addressedit" name="address" class="form-control">
                                   </div>
                                </div>
                            </div>
                        </div>
                         <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <textarea name="des" id="desedit" cols=10" rows="3" class="form-control"></textarea>
                                   </div>
                                </div>
                            </div>
                             <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="row">
                                   ...
                                   <div class="col-md-7">
                                        <input type="text" placeholder="Title" id="addressview" readonly name="address" class="form-control">
                                   </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).on('click','#editData',function(){
        ...
        $.ajax({
        url: '{{ route('edit_testimoniumpage') }}',
        method: 'GET',
        dataType: "JSON",
        data: { 'id': itemId },
        success: function (response) {
            ...
            var fullImageUrl = "{{ asset('public/testimoniumimage') }}/" + imageUrl;
